    ...
    <div class="atbd-page-content">
        <div class="container-fluid">
            <div class="card">
                ...
                <form method="POST" action="{{ route('ayarlar.create.update') }}" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group mb-0" style='text-align: center;'>
                                            ...
                                            <img style='max-width: 178px;' src="{{ asset($ayarVerileri->logo) }}"
                                                alt="svg">
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="input-container icon-left position-relative">
                                                ...
                                                <textarea name="adres" id="adres"
                                                    class="form-control form-control-default">{{$ayarVerileri->adres}}</textarea>
                                    ...
                                    <div class="col-md-4 mt-2">
                                        <div class="form-group mb-0">
                                            <div class="input-container icon-left position-relative">
                                                ...
                                                <input name="tel" id="tel" min="1000000000" max="9999999999"
                                                    value="{{$ayarVerileri->tel}}" type="number"
                                                    class="form-control form-control-default"
                                                    placeholder="Telefon numasını giriniz.">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mt-2">
                                        <div class="form-group mb-0">
                                            <div class="input-container icon-left position-relative">
                                                ...
                                                <input name="e_posta" id="e_posta" value="{{$ayarVerileri->e_posta}}"
                                                    type="email" class="form-control form-control-default"
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="input-container icon-left position-relative">
                                                ...
                                                <textarea name="maps" id="maps" type="text"
                                                    class="form-control form-control-default">{{$ayarVerileri->maps}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mt-2">
                                        <div class="form-group mb-0">
                                            <div class="input-container icon-left position-relative">
                                                ...
                                                <input name="face" id="face" type="text" value="{{$ayarVerileri->face}}"
                                                    class="form-control form-control-default"
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="input-container icon-left position-relative">
                                                ...
                                                <input name="linkedin" id="linkedin" type="text"
                                                    value="{{$ayarVerileri->linkedin}}"
                                                    class="form-control form-control-default"
                                                    placeholder="Linkedin adresinizi giriniz.">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="input-container icon-left position-relative">
                                                ...
                                                <input name="gmail" id="gmail" type="email"
                                                    value="{{$ayarVerileri->gmail}}"
                                                    class="form-control form-control-default"
                                                    placeholder="Gmail adresinizi giriniz.">
                                            </div>
                                        </div>
                                    </div>
